...
describe('Post Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Blog query and add missing value', () => {
      ...
      const blog: IBlog = { id: 30397 };
      post.blog = blog;

      const blogCollection: IBlog[] = [{ id: 24602 }];
    ...
    it('Should call Tag query and add missing value', () => {
      const post: IPost = { id: 456 };
      const tags: ITag[] = [{ id: 5208 }];
      post.tags = tags;

      const tagCollection: ITag[] = [{ id: 1206 }];
    ...
    it('Should update editForm', () => {
      const post: IPost = { id: 456 };
      const blog: IBlog = { id: 467 };
      post.blog = blog;
      const tag: ITag = { id: 10924 };
      post.tags = [tag];
