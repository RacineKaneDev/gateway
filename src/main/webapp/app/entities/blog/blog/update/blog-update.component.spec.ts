...
describe('Blog Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      ...
      const user: IUser = { id: 'fed32844-6718-4690-acdc-780b4cce0c75' };
      blog.user = user;

      const userCollection: IUser[] = [{ id: '5eb6385c-e9ec-4ddf-b669-f4facaac5724' }];
    ...
    it('Should update editForm', () => {
      const blog: IBlog = { id: 456 };
      const user: IUser = { id: '01ed7aa5-c58e-4564-a95b-bd3ebe0d4aad' };
      blog.user = user;
